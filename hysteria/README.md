...
```
nat PREROUTING  -i enp0s6 -p tcp --dport 32400 -j DNAT --to 100.125.140.11:32400
nat POSTROUTING -d 100.125.140.11/32 -p tcp --dport 32400 -j MASQUERADE
filter FORWARD  -d 100.125.140.11/32 -p tcp --dport 32400 -j ACCEPT
```
