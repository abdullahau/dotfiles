# Generated by Powerlevel10k configuration wizard on 2026-09-25 at 11:14 +04.
...
() {
  ...
  # Status on success. No content, just an icon. The wizard leaves this off and
  # lets prompt_char turn green instead. We want the chip as well.
  ...
  # Status when it's just an error code (e.g., '1'). The wizard leaves this off
  # and lets prompt_char turn red instead, which hides the number. We want it.
